        ...
        <div className="mn-sidebar-wrap">
          <div className="mn-sidebar-block drop">
            <div className="mn-sb-title">
              <h3 className="mn-sidebar-title">Delivery Options </h3>
            </div>
            <div className="mn-sb-block-co;ntent p-t-15">
              <ul>
          ...
          <div className="mn-sidebar-block">
            <div className="mn-sb-title">
              <h3 className="mn-sidebar-title">Return & Warranty </h3>
            </div>
          ...
          <div className="mn-sidebar-block">
            <div className="mn-sb-title">
              <h3 className="mn-sidebar-title">Vendor</h3>
            </div>
            <div className="mn-sb-block-content tab-content mn-single-pro-tab-content">
              <div id="mn-spt-nav-vendor" className="tab-pane active">
